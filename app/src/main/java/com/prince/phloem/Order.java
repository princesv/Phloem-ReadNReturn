...
public class Order{
    ...
    public Order(String id,String name, Long contact, String physics, String chemistry, String mathematics, String economics, String accounts, String bst, String fnf,String competitiveBooks,String others) {
        this.id=id;
        this.name =""+ name;
